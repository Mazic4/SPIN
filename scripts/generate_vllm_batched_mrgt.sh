...
data_dir="./mrgt/spin-generated/v2/init"

# output_dir="./mrgt/test_generated/v2/sft"
...
for checkpoint in 315; do
    model_dir="/maas-vepfs/spin-outputs/ecom/mrgt/v2/iter3/checkpoint-$checkpoint"
    output_dir="./mrgt/test_generated/v2/iter3/checkpoint-$checkpoint"
