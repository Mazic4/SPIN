...
# --learning_rate=1e-7: Sets the learning rate for the training process.ls
...
config_path=configs/test_7b/config_iter0.yaml
output_dir="/maas-vepfs/spin-outputs/7b/iter0"
