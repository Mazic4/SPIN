...
def main():
    ...
    if "tulu" in args.data:
        print("Processing tulu-v2.")
        train_data, test_data = load_and_process_data_tuluv2(args.data)
    elif "ultrachat" in args.data:
        print("Processing ultrachat-200k.")
        train_data = load_and_process_data_ultrachat(args.data, split='train_sft')
